<script>
import BasicPostInput from "./BasicPostInput.svelte";
import BasicGetInput from "./BasicGetInput.svelte";
import BasicPutInput from "./BasicPutInput.svelte";
import BasicDeleteInput from "./BasicDeleteInput.svelte";
